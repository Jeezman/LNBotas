    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center space-x-1 mt-1">
                ...
                <span className={`text-sm font-medium ${priceChange.isPositive ? 'text-success' : 'text-danger'}`}>
                  {priceChange.value}
                </span>
              </div>
            </div>
            <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center">
              <Bitcoin className="text-orange-500 h-6 w-6" />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">Open Interest</p>
              <p className="text-2xl font-mono font-bold text-gray-900">
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Next: 6h 23m</p>
            </div>
